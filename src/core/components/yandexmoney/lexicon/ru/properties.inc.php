...
$_lang['prop_yandexmoney.status_shipping'] = 'Отправлен';
$_lang['prop_yandexmoney.status_complete'] = 'Выполнен';
$_lang['prop_yandexmoney.status_cancelled'] = 'Отменён';
$_lang['prop_yandexmoney.status_payment_complete'] = 'Оплата получена';
